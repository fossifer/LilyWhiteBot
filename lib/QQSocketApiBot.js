...
class QQSocketApiBot extends EventEmitter {
    constructor (options = {}) {
        ...
        this._coolqCache = options.coolqCache;
        this._legacy = options.legacy;
        this._CoolQPro = options.CoolQPro;
        this._qq = undefined;
        ...
        if (type === 'PrivateMessage' || type === 'GroupMessage' || type === 'DiscussMessage') {
            return new Promise((resolve, reject) => {
                ...
                let timeOut = setTimeout(() => {
                    stop = true;
                    reject(new Error('QQBot send operation timeout'));
                }, 1000);
                const done = (info) => {
                    if (!stop) {
    ...
    groupMemberInfo(group, qq, noCache = true) {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot groupMemberInfo operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    strangerInfo(qq, noCache = true) {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot strangerInfo operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    sayHello() {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot sayHello operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    loginNick() {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot loginNick operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    groupMemberList(group) {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot groupMemberList operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    cookies() {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot cookies operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    csrfToken() {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot csrfToken operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    loginQQ() {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot loginQQ operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    appDirectory() {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot appDirectory operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    groupList() {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot groupList operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    record(file, format = 'wav') {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot record operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    cqDirectory() {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot cqDirectory operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    image(file) {
        return new Promise((resolve, reject) => {
            if (this._legacy) {
                // 从cqimg缓存中获取信息
                let p = path.join(this._coolqCache, 'image', file) + '.cqimg';
                ...
                let timeOut = setTimeout(() => {
                    stop = true;
                    reject(new Error('QQBot image operation timeout'));
                }, 1000);
                const done = (info) => {
                    if (!stop) {
                        clearTimeout(timeOut);
    ...
    voice(name) {
        return Promise.resolve({
            path: path.join(this._coolqCache, 'record', name)
        })
    }
    ...
    canSendImage() {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot canSendImage operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
    ...
    canSendRecord() {
        return new Promise((resolve, reject) => {
            ...
            let timeOut = setTimeout(() => {
                stop = true;
                reject(new Error('QQBot canSendRecord operation timeout'));
            }, 1000);
            const done = (info) => {
                if (!stop) {
                    clearTimeout(timeOut);
