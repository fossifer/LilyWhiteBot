...
class QQMessageHandler extends MessageHandler {
    constructor (client, options = {}) {
        ...
        this._isAirA = options.CoolQAirA && true;
    ...
    get isCoolQAirA() { return this._isAirA; }
    ...
    say(target, message, options = {}) {
        if (!this._enabled) {
            ...
            if (target.toString().startsWith('@')) {
                ...
                return this._client.sendPrivateMessage(realTarget, message, options);
            } else {
                if (options.isPrivate) {
                    return this._client.sendPrivateMessage(target, message, options);
                } else {
                    return this._client.sendGroupMessage(target, message, options);
                }
            }
        }
    }
